        ...
        <section class="grid gap-6 lg:grid-cols-3">
            ...
            <div class="rounded-3xl bg-white p-6 shadow-lg ring-1 ring-slate-200">
                ...
                <p class="mt-3 text-4xl font-semibold text-slate-900">
                    {{ number_format($totalProfil) }}
                </p>

                <p class="mt-2 text-sm text-slate-500">
                    Jumlah dosen dalam basis data SDM.
                </p>
            ...
            <div class="rounded-3xl bg-white p-6 shadow-lg ring-1 ring-slate-200">
                ...
                <p class="text-sm font-medium text-slate-500">
                    Total Data Kepangkatan
                </p>

                <p class="mt-3 text-4xl font-semibold text-slate-900">
                    {{ number_format($totalKepangkatan) }}
                </p>

                <p class="mt-2 text-sm text-slate-500">
                    Cakupan data kenaikan pangkat yang tercatat.
                </p>
            ...
            <!-- STATUS KEPANGKATAN -->
            <div class="rounded-3xl bg-gradient-to-br from-blue-600 to-blue-700 p-6 text-white shadow-lg sm:p-8">

                <p class="text-sm font-medium text-blue-100">
                    Status Kepangkatan
                </p>

                <ul class="mt-4 space-y-4 text-sm leading-7 text-blue-50">

                    <!-- MERAH -->
                    <li>
                        -
                        <span
                            class="inline-flex items-center justify-center min-w-[80px] rounded px-3 py-1 text-center text-slate-900"
                            style="background-color: rgba(255, 0, 0, 0.35);"
                        >
                            Merah
                        </span>

                        : Sudah lewat TMT tapi belum mengurus Publikasi.
                    </li>
                    ...
                    <li>
                        ...
                        : Masih dalam periode TMT dan belum punya publikasi dan/atau jika sudah melewati periode TMT namun sudah mengurus publikasi.
                    </li>
                    ...
                    <li>
                        ...
                        <span
                            class="inline-flex items-center justify-center min-w-[80px] rounded px-3 py-1 text-center text-slate-900"
                            style="background-color: rgba(0, 255, 0, 0.35);"
                        >
                            Hijau
                        </span>

                        : Jika sedang maupun belum menjalani periode TMT namun sudah mengurus publikasi.
                    </li>

                </ul>

                <p class="mt-5 text-xs uppercase tracking-wide text-blue-100">
                    Gunakan modul kepangkatan untuk memperbarui status.
                </p>
            ...
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500">
                        Hubungi tim support untuk bantuan teknis atau kendala penggunaan dashboard.
                    </p>
                </div>
