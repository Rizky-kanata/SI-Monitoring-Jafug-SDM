...
@section('content')
    <div class="rounded-3xl bg-white p-8 shadow-xl ring-1 ring-slate-200">
        <div class="space-y-1">
            ...
            <h1 class="text-2xl font-semibold text-slate-900">Tambah Data Kepangkatan</h1>
            <p class="text-sm text-slate-500">Lengkapi informasi kepangkatan untuk terhubung dengan profil dosen KK RIIB.</p>
        </div>
